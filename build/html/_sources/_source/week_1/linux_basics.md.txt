...
### ls Command ###
 ...
 1. Type `ls *.txt`.  Only the file `test.txt` will be displayed. This will display all the files with .txt extension
...
### `pwd` and `cd` Commands ###
 ...
 1. Enter `cd ..` into the terminal to go back to the previous directory
 ...
 1. Enter `cd ~/new` to return to our working directory.
